...
if ( ! class_exists( 'Klaviyo_WP_Meta_Sync_Admin_API_Handler' ) ) :
	...
	class Klaviyo_WP_Meta_Sync_Admin_API_Handler {
		 ...
		 *
		 * @var Klaviyo_WP_Meta_Sync_API_Handler|null
		 */
		private static $instance = null;

		/**
		 * Klaviyo API client instance.
		 *
		 * @var Klaviyo_API_Client
		 */
		private $klaviyo;
		...
		public function create_or_update_profile( $profile_data ) {
			try {
				...
				Klaviyo_WP_Meta_Sync_Utilities::send_error_notification( $user_email, $error_code, $error_message, $request_data );
